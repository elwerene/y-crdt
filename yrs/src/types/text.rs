...
impl Text {
    ...
    pub fn find_position(&self, txn: &mut Transaction, index: u32) -> Option<ItemPosition> {
        let mut pos = {
    ...
    pub fn update_current_attributes(attrs: &mut Attrs, key: &str, value: &Any) {
...
impl TextEvent {
    pub fn new(branch_ref: BranchPtr) -> Self {
    ...
    pub fn get_delta(target: BranchPtr, txn: &Transaction) -> Vec<Delta> {
